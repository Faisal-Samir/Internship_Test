    ...
    return (
        <div className="container mb-5">
            <div className="row">
                ...
                <div className="col-md-6 d-none d-lg-block  position-absolute shadow p-4 bg-blue bg-opacity-50 rounded  text-white text-center" style={{top:'420px',left:'400px',margin:'auto'}}>
